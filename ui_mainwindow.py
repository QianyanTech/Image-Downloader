...
"}*/")
        ...
        self.radioButton_other = QtWidgets.QRadioButton(self.widget_engine)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.radioButton_other.setFont(font)
        self.radioButton_other.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.radioButton_other.setObjectName("radioButton_other")
        self.buttonGroup.addButton(self.radioButton_other)
        self.horizontalLayout.addWidget(self.radioButton_other)
        ...
        self.radioButton_other.toggled['bool'].connect(self.checkBox_safe_mode.setChecked)
        ...
        MainWindow.setTabOrder(self.radioButton_baidu, self.radioButton_other)
        MainWindow.setTabOrder(self.radioButton_other, self.plainTextEdit_log)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_other.setText(_translate("MainWindow", "Unsplash"))
