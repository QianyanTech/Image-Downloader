...
"}*/")
        ...
        self.radioButton_unsplash = QtWidgets.QRadioButton(self.widget_engine)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.radioButton_unsplash.setFont(font)
        self.radioButton_unsplash.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.radioButton_unsplash.setObjectName("radioButton_unsplash")
        self.buttonGroup.addButton(self.radioButton_unsplash)
        ...
        self.radioButton_firefox = QtWidgets.QRadioButton(self.widget_driver)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.radioButton_firefox.setFont(font)
        self.radioButton_firefox.setObjectName("radioButton_firefox")
        self.horizontalLayout_6.addWidget(self.radioButton_firefox)
        ...
        self.gridLayout.addWidget(self.checkBox_from_file, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_path2file, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_load_file, 2, 2, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.widget_keywords)
        ...
        self.lineEdit_resolution = QtWidgets.QLineEdit(self.widget_keywords)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_resolution.setFont(font)
        self.lineEdit_resolution.setAcceptDrops(True)
        self.lineEdit_resolution.setObjectName("lineEdit_resolution")
        self.gridLayout.addWidget(self.lineEdit_resolution, 1, 1, 1, 2)
        ...
        self.label_8.setBuddy(self.lineEdit_resolution)
        ...
        self.radioButton_unsplash.toggled['bool'].connect(self.checkBox_safe_mode.setChecked)
        ...
        MainWindow.setTabOrder(self.radioButton_baidu, self.radioButton_unsplash)
        MainWindow.setTabOrder(self.radioButton_unsplash, self.plainTextEdit_log)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_unsplash.setText(_translate("MainWindow", "Unsplash"))
        ...
        self.lineEdit_resolution.setToolTip(_translate("MainWindow", "HEIGHTxWIDTH e.g 1400x800"))
        self.lineEdit_resolution.setStatusTip(_translate("MainWindow", "1400x800, 1920x1020 etc"))
        self.lineEdit_resolution.setPlaceholderText(_translate("MainWindow", "HEIGHTxWIDTH E.g 1400x800, 1920x1020 etc."))
