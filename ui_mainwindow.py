...
"}*/")
        ...
        self.widget = QtWidgets.QWidget(self.groupBox_config)
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.radioButton_google = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.radioButton_bing = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.radioButton_baidu = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.widget_2 = QtWidgets.QWidget(self.groupBox_config)
        ...
        self.lineEdit_keywords = QtWidgets.QLineEdit(self.widget_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.checkBox_from_file = QtWidgets.QCheckBox(self.widget_2)
        ...
        self.lineEdit_path2file = QtWidgets.QLineEdit(self.widget_2)
        ...
        self.pushButton_load_file = QtWidgets.QPushButton(self.widget_2)
        ...
        self.widget_6 = QtWidgets.QWidget(self.groupBox_config)
        ...
        self.lineEdit_output = QtWidgets.QLineEdit(self.widget_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_output = QtWidgets.QPushButton(self.widget_6)
        ...
        self.widget_4 = QtWidgets.QWidget(self.groupBox_config)
        self.widget_4.setObjectName("widget_4")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget_4)
        self.horizontalLayout_2.setContentsMargins(0, 9, 0, 9)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.checkBox_proxy = QtWidgets.QCheckBox(self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
